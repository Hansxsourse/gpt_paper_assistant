...
0. [Towards Agnostic and Holistic Universal Image Segmentation with Bit Diffusion](#link0)
**Authors:** Jakob L{\o}nborg Christensen, Morten Rieger Hannemose, Anders Bjorholm Dahl, Vedrana Andersen Dahl

---
## 0. [Towards Agnostic and Holistic Universal Image Segmentation with Bit Diffusion](https://arxiv.org/abs/2601.02881) <a id="link0"></a>
**ArXiv ID:** 2601.02881
**Authors:** Jakob L{\o}nborg Christensen, Morten Rieger Hannemose, Anders Bjorholm Dahl, Vedrana Andersen Dahl
...
**Comment:** Matches criterion 2: Introduces a diffusion-based framework for universal image segmentation, but does not mention multi-task capabilities.
**Relevance:** 3
**Novelty:** 5

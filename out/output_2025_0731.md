...
0. [DepR: Depth Guided Single-view Scene Reconstruction with Instance-level Diffusion](#link0)
**Authors:** Qingcheng Zhao, Xiang Zhang, Haiyang Xu, Zeyuan Chen, Jianwen Xie, Yuan Gao, Zhuowen Tu

---
## 0. [DepR: Depth Guided Single-view Scene Reconstruction with Instance-level Diffusion](https://arxiv.org/abs/2507.22825) <a id="link0"></a>
**ArXiv ID:** 2507.22825
**Authors:** Qingcheng Zhao, Xiang Zhang, Haiyang Xu, Zeyuan Chen, Jianwen Xie, Yuan Gao, Zhuowen Tu
